...
export const POST_TOP_LIKED_REQUEST ='POST_TOP_LIKED_REQUEST'
export const POST_TOP_LIKED_SUCCESS ='POST_TOP_LIKED_SUCCESS'
export const POST_TOP_LIKED_FAIL ='POST_TOP_LIKED_FAIL'
...
export const POST_UPDATE_LIKES_RESET = 'POST_UPDATE_LIKES_RESET'